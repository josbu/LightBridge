...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, settingService *service.SettingService) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/models/discover-upstream", h.Admin.Account.DiscoverUpstreamModels)
		accounts.POST("/check-mixed-channel", h.Admin.Account.CheckMixedChannel)
		accounts.POST("/import/codex-session", h.Admin.Account.ImportCodexSession)
		accounts.POST("/sync/crs", h.Admin.Account.SyncFromCRS)
		accounts.POST("/sync/crs/preview", h.Admin.Account.PreviewFromCRS)
		accounts.POST("/repair/openai-oauth-platform", h.Admin.Account.RepairOpenAIOAuthPlatform)
...
func registerGrokOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	grok := admin.Group("/grok")
	{
		...
		grok.POST("/accounts/:id/quota", h.Admin.GrokOAuth.QueryQuota)
