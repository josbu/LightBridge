...
import (
	...
	"github.com/WilliamWang1721/LightBridge/ent/idempotencyrecord"
	...
	"github.com/WilliamWang1721/LightBridge/ent/schema"
	"github.com/WilliamWang1721/LightBridge/ent/securitysecret"
	"github.com/WilliamWang1721/LightBridge/ent/setting"
	"github.com/WilliamWang1721/LightBridge/ent/subscriptionplan"
	"github.com/WilliamWang1721/LightBridge/ent/tlsfingerprintprofile"
	"github.com/WilliamWang1721/LightBridge/ent/usagecleanuptask"
	"github.com/WilliamWang1721/LightBridge/ent/usagelog"
	"github.com/WilliamWang1721/LightBridge/ent/user"
	"github.com/WilliamWang1721/LightBridge/ent/userallowedgroup"
...
func init() {
	...
	// accountDescSubPlatform is the schema descriptor for sub_platform field.
	accountDescSubPlatform := accountFields[4].Descriptor()
	// account.DefaultSubPlatform holds the default value on creation for the sub_platform field.
	account.DefaultSubPlatform = accountDescSubPlatform.Default.(string)
	// account.SubPlatformValidator is a validator for the "sub_platform" field. It is called by the builders before save.
	account.SubPlatformValidator = accountDescSubPlatform.Validators[0].(func(string) error)
