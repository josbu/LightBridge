export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      repairOpenAIOAuthPlatform: 'Repair OpenAI OAuth Platform',
      repairOpenAIOAuthPlatformConfirm: 'This will scan accounts marked as Gemini OAuth whose credentials belong to OpenAI OAuth, then change them back to OpenAI. Real Gemini OAuth accounts will not be modified. Continue?',
      repairOpenAIOAuthPlatformCompleted: 'Repair completed: repaired {repaired} account(s), scanned {scanned} Gemini OAuth account(s).',
      repairOpenAIOAuthPlatformCompletedWithErrors: 'Repair completed with errors: repaired {repaired}, failed {failed}, scanned {scanned}.',
      repairOpenAIOAuthPlatformNoChanges: 'No OpenAI OAuth accounts need repair. Scanned {scanned} Gemini OAuth account(s).',
      repairOpenAIOAuthPlatformFailed: 'Failed to repair OpenAI OAuth platform',
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      ...
      verifyAuthenticityDone: 'Authenticity check complete: {verdict}',
      verifyAuthenticityFailed: 'Failed to verify authenticity',
      ...
      authenticity: {
        ...
        unknown: 'Unknown',
        checkedAt: 'Checked',
        method: { probe: 'Active probe', passive: 'Passive detection' }
      },
      resetStatus: 'Reset Status',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another LightBridge instance.',
      ...
      gemini: {
        ...
        proxyManagedHint: 'This access type is backed by an aistudio-api reverse-proxy subprocess that LightBridge starts automatically. You do not need to enter an upstream URL or token — just paste a Google login cookie once to bind the session. LB launches the process on the first request.',
        proxyCookieLabel: 'Google Login Cookie',
        proxyCookiePlaceholder: 'Paste a Google cookie string copied from the browser (e.g. SID=...; __Secure-1PSID=...; ...)',
        proxyCookieHint: 'Sign in at https://myaccount.google.com, then export the cookies with a browser extension and paste them here. Cookies expire quickly and must be re-pasted when they do.',
        proxyCookieBound: 'Google session bound to the AIStudio reverse-proxy account.',
        proxyCookieBindFailed: 'Failed to bind cookie: ',
        proxyRuntimeTitle: 'Runtime Environment',
        proxyRuntimeCheck: 'Check',
        proxyRuntimeChecking: 'Checking…',
        proxyRuntimeReady: 'Runtime ready (Python + aistudio-api + browser).',
        proxyRuntimeNotReady: 'Runtime not ready — installation required.',
        proxyRuntimeInstallHint: 'Click the button below to auto-install aistudio-api and its dependencies. On Linux, missing system libraries must be installed manually via apt as prompted.',
        proxyRuntimeInstall: 'Install',
        proxyRuntimeInstalling: 'Installing… please keep this page open',
        proxyRuntimeInstallDone: 'Runtime installation complete.',
        proxyRuntimeInstallFailed: 'Runtime installation failed.',
        proxyBindModeLabel: 'Google account binding method',
        proxyBindModeCookie: 'Paste Cookie',
        proxyBindModeLogin: 'Guided Login',
        proxyBindModeHint: 'Guided login opens a headed browser window (host needs GUI/xvfb). Use Paste Cookie on headless hosts.',
        proxyLoginHint: 'After creating the account, a browser window opens automatically — complete Google sign-in there and the session is captured automatically.',
        proxyLoginStarted: 'Browser login started — complete Google sign-in in the popup window…',
        proxyLoginDone: 'Google login complete, session bound.',
        proxyLoginFailed: 'Guided login failed: ',
        proxyBaseUrlHint: 'Enter your aistudio-api reverse-proxy URL (e.g. http://host:8080). Non-HTTPS upstreams must be allowed in system settings.',
        proxyTokenHint: 'The auth token (secret_token) configured in your aistudio-api instance.',
        helpButton: 'Help',
        helpDialog: {
      ...
      lightBridgeConnect: {
        ...
        refreshBalanceSuccess: 'Balance refreshed',
        refreshBalanceFailed: 'Failed to refresh balance',
        openConsole: 'New API Console',
        consoleUrlMissing: 'This account has no New API instance URL; cannot open console',
        userId: 'New API User ID',
        userIdPlaceholder: 'e.g. 1',
        userIdHint: 'Your numeric New API user ID, sent as the New-Api-User header (required). Find it in New API: Personal Settings.',
    ...
    settings: {
      ...
      features: {
        ...
        privacyFilter: {
          ...
          configureLink: 'Configure redaction rules in Privacy Filter',
          enabled: 'Enable Privacy Filter',
          enabledHint: 'When off, the admin sidebar entry is hidden and gateway request/response redaction is skipped.',
        },
        affiliate: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for LightBridge end-user login',
      ...
      dingtalk: {
        title: 'DingTalk Login',
        description: 'Configure DingTalk OAuth for LightBridge end-user login',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'LightBridge',
        useTls: 'Use TLS',
      ...
      authenticity: {
        title: 'Claude Authenticity Detection',
        description: 'Detect whether Claude/Anthropic accounts are genuine by verifying thinking signatures',
        enabled: 'Enable Passive Detection',
        enabledHint: 'When enabled, inspect responses to thinking-enabled requests for valid signatures; flag accounts that consistently lack them',
        threshold: 'Suspicious Threshold',
        thresholdHint: 'Number of consecutive thinking-enabled responses without a valid signature before an account is flagged as counterfeit',
        saved: 'Authenticity settings saved',
        saveFailed: 'Failed to save authenticity settings'
      },
      betaPolicy: {
        title: 'Beta Policy',
