/**
 * Core Type Definitions for LightBridge Frontend
 */
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'grok' | 'antigravity' | 'custom'
...
export interface Account {
  ...
  notes?: string | null
  platform: AccountPlatform
  protocol?: AccountProtocol | string
  type: AccountType
...
export type AdminDataImportPayload = AdminDataPayload | Record<string, unknown> | string
